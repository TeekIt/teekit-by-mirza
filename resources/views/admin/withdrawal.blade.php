    ...
    <div class="content">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-12">
                        <h4 class="py-4 my-1 text-site-primary">Seller Withdrawal Requests</h4>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <table class="table text-center table-hover border-bottom">
                                        ...
                                        <tbody>
                                            @forelse ($transactions as $transaction)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" data-bs-toggle="modal"
                                                            data-bs-target="#bankModal{{ $transaction->id }}"
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="bankModal{{ $transaction->id }}" tabindex="-1"
                                                    role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            {{-- <form action=""> --}}
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">User Bank
                                                                    Detail</h5>
                                                                ...
                                                                @foreach (json_decode($transaction->bank_detail) as $key => $bank)
                                                                    ...
                                                                    <div class="row text-left">
                                                                        @foreach ($bank as $key1 => $b)
                                                                            <div
                                                                                class="col-md-6 font-weight-bold text-capitalize">
                                                                                {{ str_replace('_', ' ', $key1) }}
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                {{ $b }}
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="status" class="form-control">
                                                                                    <option
                                                                                        @if ($transaction->status == 'Pending') SELECTED @endif
                                                                                        value="Pending">
                                                                                        Pending
                                                                                    </option>
                                                                                    <option
                                                                                        @if ($transaction->status == 'Cancelled') SELECTED @endif
                                                                                        value="Cancelled">
                                                                                        Cancelled
                                                                                    </option>
                                                                                    <option
                                                                                        @if ($transaction->status == 'Completed') SELECTED @endif
                                                                                        value="Completed">
                                                                                        Completed
                                                                                    </option>
                                                                                </select>
