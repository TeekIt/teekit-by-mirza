...
class AddVanInventoryLivewire extends Component
{
    ...
    public function render(): View
    {
        ...
        $products = Products::getParentOrChildSellerProductsForView((int) $this->nearBySellerId, search: $this->productSearch, orderBy: 'desc');

        return view('livewire.admin.add-van-inventory-livewire', compact('sellers', 'products'));
    }
}
